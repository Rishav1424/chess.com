...
public record GameEntityResponse(Long id, String whitePlayerName, String blackPlayerName, Instant started, Instant finished, GameStatus status, String[] moves) {
